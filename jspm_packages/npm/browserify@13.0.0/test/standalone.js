...
test('standalone', function(t) {
  t.plan(3);
  var b = browserify(__dirname + '/standalone/main.js', {standalone: 'stand-test'});
  b.bundle(function(err, src) {
    ...
    t.test('RequireJS', function(t) {
      t.plan(2);
      var c = {define: function(dependencies, fn) {
          fn()(done(t));
        }};
      c.define.amd = true;
...
test('A.B.C standalone', function(t) {
  t.plan(3);
  var b = browserify(__dirname + '/standalone/main.js', {standalone: 'A.B.C'});
  b.bundle(function(err, src) {
    t.test('window global', function(t) {
      t.plan(2);
      var c = {window: {}};
